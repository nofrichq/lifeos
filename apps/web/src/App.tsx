        ...
        <section className="grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
          ...
          <article className="rounded-2xl border border-white/10 bg-white/[0.04] p-6">
            ...
            <p className="mt-4 text-sm leading-6 text-slate-300">
              Career and Projects are the most active areas this week. Keep the dashboard scope
              small, finish the visual shell, and avoid adding backend work before the first usable
              screen is ready.
            </p>
